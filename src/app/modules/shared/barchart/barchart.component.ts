...
import { SimpleDataModel } from '../Model/charts/charts.model';
 
interface StackedChart{
	stockAgedLe30: number,
	stockAgedGt30Le60: number,
	stockAgedGt60Le90: number,
	stockAgedGt90: number,
	date: number
}
...
export class BarchartComponent implements OnInit { 
  ...
  @Input() yTitle: string;
	...
	private colors = ['rgb(64, 160, 0)', 'rgb(197, 141, 0)', 'rgb(160, 0, 0)', 'rgb(0, 131, 112)'];
